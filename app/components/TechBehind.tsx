        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ scale: 1.05, backgroundColor: 'rgb(31 41 55 / 0.5)' }}
              className="flex items-center gap-3 bg-gray-800/30 rounded-lg p-4 shadow-lg border border-gray-700/50 transition-all"
            >
              <span className="text-[#00FFC6]">{feature.icon}</span>
