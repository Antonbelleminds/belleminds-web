    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl text-[#00FFC6] mb-12 font-medium"
        >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => {
              document.getElementById('bellebook-details')?.scrollIntoView({ behavior: 'smooth' });
            }}
