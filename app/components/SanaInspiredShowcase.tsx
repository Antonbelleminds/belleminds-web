    ...
    <section className="py-24 px-4 bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Kraftfulla AI-verktyg som förändrar hur du jobbar
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-3 mb-12 flex-wrap">
          {tabs.map((tab, index) => (
            <motion.button
              ...
              className={`relative overflow-hidden rounded-full font-semibold bg-white ${
                activeTab === index
                  ? 'shadow-lg scale-105'
            ...
            >
              ...
              <div className="relative px-6 py-3" style={{ zIndex: 10 }}>
                {/* Black text (default) */}
                <span 
                ...
                {activeTab === index && (
                  ...
                  >
                    <div className="px-6 py-3 text-base font-semibold whitespace-nowrap" style={{ color: '#FFFFFF' }}>
                      {tab.label}
                    </div>
                  </div>
                )}
          ...
          <motion.button
            ...
            className="ml-2 p-3.5 rounded-full bg-white hover:bg-gray-50 transition-all duration-300 shadow-md hover:shadow-lg group"
            aria-label={isPaused ? 'Play' : 'Pause'}
          >
            {isPaused ? (
              <svg className="w-5 h-5 text-gray-700 group-hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
