...
const icons = [
  <svg key="blog" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>,
  <svg key="podcast" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const contentCards = content.inspiration.cards.map((card, index) => ({
  ...card,
  icon: icons[index],
}));
      ...
      <div className="max-w-6xl mx-auto">
          ...
          {contentCards.map((card, index) => (
            ...
            >
              ...
              <span className="text-[#00FFC6] font-medium inline-flex items-center gap-2">
                {content.inspiration.comingSoon}
        ...
        >
          <p className="text-[#EAEAEA] mb-4">
            {content.inspiration.linkedIn.text}
          </p>
          <motion.a
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            href={content.inspiration.linkedIn.url}
            target="_blank"
          ...
          >
            ...
            {content.inspiration.linkedIn.buttonText}
          </motion.a>
        </motion.div>
      </div>
    </section>
